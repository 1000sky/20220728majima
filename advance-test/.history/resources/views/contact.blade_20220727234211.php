...
<body>
    ...
    <form action="/create" method="POST">
      ...
      <table>
        ...
        <td><input type="text" name="fullname"></td><p>例）山田</p><td><input type="text" name="fullname"></td><P>例）太郎</P>
        ...
        <label>
            性別 
                <input type="radio" name="gender" checked="checked"><label for="">男性</label>
                <input type="radio" name="gender"><label for="">女性</label>
        </label>
        </tr>
