    ...
    <form action="/create" method="POST">
      ...
      <table>
        ...
        <tr>
          ...
          <td><div>〒</div></td><td><input type="text"></td>
        </tr>
        <tr> 
        ...
        <tr>
           <th><label for="">住所</label></th>
           <td><input type="text" style="ime-mode:disabled;"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><p>例）千駄ヶ谷マンション101</p></td>
        </tr>
        
        <tr><label for="">ご意見</label></tr>
